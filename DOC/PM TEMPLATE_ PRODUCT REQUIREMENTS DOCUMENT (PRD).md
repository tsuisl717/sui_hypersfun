...
Define the purpose and goals of the PSD. What problem does the product solve? Who is the target audience? What are the key objectives? What value to the customer will the product provide?

## Overview

Provide a brief overview of the product, including its name, description, and any relevant background information. Explain why the product is being developed and its significance. Include input from the Voice of the Customer insights.

## Scope

Clearly outline the boundaries of the project. What is included in the product, and what is not? Define any limitations or constraints, such as budget, time frame, or technical requirements.
...
For each functional requirement, provide acceptance criteria that must be met before the feature is considered complete. These criteria help in evaluating whether the product meets its intended purpose.
...
If applicable, provide guidelines for the product's user interface (UI) and overall user experience. Include wireframes, mockups, or design concepts to help visualize the design expectations.

## Technical Considerations

Link to engineering technical approach document. Explain the data sources, data formats, and content needs of the product. If the product involves user-generated content, define content moderation guidelines.
...
Specify the testing criteria, methodologies, and tools that will be used to ensure the product's quality. Include any acceptance criteria for each feature or functionality.
...
***Note:** Link to a larger GTM and NABC brief if available.* 
